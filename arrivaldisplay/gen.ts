...
import { SVG, registerWindow, Svg } from "npm:@svgdotjs/svg.js";
...
// clock.scale(2,2)
clock.path("m7.50078,15.00156c-4.2,0 -7.5,-3.4 -7.5,-7.5s3.3,-7.5 7.5,-7.5c4.1,0 7.5,3.3 7.5,7.5s-3.4,7.5 -7.5,7.5zm0,-14c-3.6,0 -6.5,2.9 -6.5,6.5s2.9,6.5 6.5,6.5c3.6,0 6.5,-2.9 6.5,-6.5s-2.9,-6.5 -6.5,-6.5z");
clock.path("m7.00078,8.00156c-0.1,0 -0.1,0 -0.2,-0.1c-0.2,-0.1 -0.3,-0.4 -0.2,-0.6l2.5,-4.7c0.1,-0.2 0.4,-0.3 0.6,-0.2c0.2,0.1 0.3,0.4 0.2,0.6l-2.5,4.7c-0.1,0.2 -0.2,0.3 -0.4,0.3z")
  .opacity(0.6);
clock.path("m7.10078,8.00156c-0.1,0 -0.1,0 0,0c-0.3,0 -0.5,-0.2 -0.5,-0.5l0.4,-5.3c0,-0.3 0.2,-0.5 0.5,-0.4c0.3,0 0.5,0.2 0.4,0.5l-0.4,5.2c0,0.3 -0.2,0.5 -0.4,0.5z")
.opacity(0.3);
clock.path("m7.10078,8.00156c-0.1,0 -0.3,-0.1 -0.4,-0.2c-0.2,-0.2 -0.1,-0.5 0.1,-0.7l4.3,-3.2c0.2,-0.2 0.5,-0.1 0.7,0.1c0.2,0.2 0.1,0.5 -0.1,0.7l-4.4,3.2c0,0 -0.1,0.1 -0.2,0.1z");
// clock.scale(0.5,0.5,7.5,7.5);
const tracking = canvas.symbol().viewbox(0,0,20,20);
tracking.path("M7.7,18c0-3.1-2.5-5.6-5.6-5.7l0,0c-0.2,0-0.4,0-0.6-0.2l0,0v0c-0.3-0.3-0.3-0.7,0-1l0,0C1.6,11,1.7,11,1.9,10.9l0,0c0,0,0,0,0,0h0c0,0,0,0,0,0l0,0c0,0,0.1,0,0.1,0l0,0c3.9,0,7.1,3.2,7.1,7.1l0,0c0,0.4-0.3,0.7-0.7,0.7l0,0C8,18.7,7.7,18.4,7.7,18L7.7,18z M17.9,18C17.9,9.2,10.8,2.1,2,2.1l0,0v0c-0.4,0-0.7-0.3-0.7-0.7l0,0C1.3,1,1.6,0.7,2,0.7l0,0c9.5,0,17.3,7.7,17.3,17.3l0,0c0,0.4-0.3,0.7-0.7,0.7l0,0C18.2,18.7,17.9,18.4,17.9,18L17.9,18z");
tracking.path("M12.8,18C12.8,12.1,8,7.3,2.1,7.2l0,0c-0.3,0-0.6-0.1-0.7-0.4l0,0c-0.2-0.4,0-0.8,0.3-1l0,0c0,0-0.1,0,0.3-0.1l0,0c6.7,0,12.2,5.4,12.2,12.2l0,0c0,0.4-0.3,0.7-0.7,0.7l0,0C13.1,18.7,12.8,18.4,12.8,18L12.8,18z")
...
export const generateArrivalsBoard = async (stopDescription: string, arrivals: Arrival[]) => {  
  ...
  arrivals.forEach((arrival, i) => {
    ...
    canvas.text(`${trainLineString(arrival.route)} Line #${arrival.trainNumber.toString().padStart(3, "0")} to`)
      .move(25, 75 + (i * 105))
      .font({size: 20})
      .fill(inverse ? "#" + utils.lineColor(arrival.route).toString(16).padStart(6, "0") : "#FFF");
